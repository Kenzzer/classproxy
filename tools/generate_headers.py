...
def output_version_headers():
  ...
  with open(os.path.join(OutputFolder, 'extension_version_auto.h'), 'w') as fp:
    fp.write("""
...
#define EXT_BUILD_LOCAL_REV \"{6}\"

#define EXT_BUILD_UNIQUEID       EXT_BUILD_LOCAL_REV \":\" EXT_BUILD_CSET

#define EXT_VERSION_STRING	\"{5}\"
#define EXT_VERSION_FILE		{2},{3},{4},{6}
